...
EXPECTED_SVG_PATH = Path(__file__).resolve().parent / "PA_Module_Simplified" / "topology.svg.expected"
...
def test_real_case_svg_matches_committed_regression_baseline(
    ...
    assert actual_output_path.read_text(encoding="utf-8") == EXPECTED_SVG_PATH.read_text(
        encoding="utf-8"
    )
